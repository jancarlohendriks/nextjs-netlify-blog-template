...
On the contrary of Werken Bij Kindergarden, Change Inc. is built with the latest technologies such Next.js and Craft CMS, as well as GraphQL. These were exactly the technologies that I wanted to work with and get to know. 

Take a look at their [website](https://www.change.inc/)

I was able to join the team and build new parts of the website, such as the following:

![change accordion](/images/change-accordion.png "change accordion")

Furhtermore, I took take this component complied with accessibility.